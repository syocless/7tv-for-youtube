...
# БАЗОВЫЙ НАБОР СМАЙЛОВ/BASE PACK SMILES https://7tv.app/emote-sets/01FRG0ZGSR00084PQ73P1BYDX8
...
<img width="1455" height="814" alt="Снимок экрана 2026-09-15 184136" src="https://github.com/user-attachments/assets/7ffd515d-ef22-4e4c-9793-aa889e4fb1ab" />
...
**Эмодзи 7TV теперь видны не только в чате трансляций, но и в комментариях
под видео, и в постах сообщества.** Если у видео или поста используются
названия эмодзи из твоих подключённых 7TV-наборов — они отображаются
картинками, как в чате. В самих полях ввода комментариев тоже появилась
кнопка «7TV» для быстрой вставки нужного эмодзи, без необходимости
запоминать точное название.
